...
const departments = [
  {
    ...
    icon: "Code2",
    color: "",
    description: "用 TypeScript 构建流畅的 Web 体验，让界面与交互都恰到好处",
  ...
  },
  {
    ...
    icon: "Server",
    color: "",
    description: "以 Go / Java / Python 打造高可用服务，让数据稳定流转",
  ...
  },
  {
    ...
    icon: "Layers",
    color: "",
    description: "打通前后端与云原生，独立交付完整产品",
  ...
  },
  {
    ...
    icon: "Shield",
    color: "",
    description: "攻防实战与代码审计，守护系统与数据安全",
  ...
  },
  {
    ...
    icon: "Cpu",
    color: "",
    description: "以 C++ 打磨底层与高性能计算，向效率极致进军",
  ...
  },
  {
    ...
    icon: "Brain",
    color: "",
    description: "用 Python 与机器学习探索智能边界，驱动数据价值",
...
const members = [
  {
    ...
    department: "frontend",
    position: "工作室负责人",
    bio: "热爱前端架构与 TypeScript，相信代码可以改变世界。",
  ...
  },
  {
    ...
    department: "ai",
    position: "AI 组组长",
    bio: "痴迷于机器学习与数据科学，坚信 AI 是未来十年的核心驱动力。",
...
members.forEach((m, i) =>
  insertMember.run({ ...m, skills: JSON.stringify(m.skills), sort_order: i }),
);
...
const timeline = [
  {
    year: "2015",
    title: "典创工作室成立",
    description: "由 3 名计算机系同学发起，最初定位为前端技术小组。",
  },
  {
    year: "2022",
    title: "首个产品上线",
    description: "校园失物招领系统「FoundYou」正式上线，注册用户突破 3000。",
  },
  {
    year: "2023",
    title: "工作室扩招",
    description: "多位优秀的团队成员加入工作室，团队规模达到 15 人。",
  },
  {
    year: "2024",
    title: "国家级A类赛事",
    description: "工作室成员全员荣获多项A类赛事的省级以上奖项。",
  },
  {
    year: "2025末",
    title: "首位学长保研",
    description: "毕金成学长以专业第一的优异成绩保研至苏州大学。",
  },
  {
    year: "2026",
    title: "全新官网",
    description: "你正在浏览的官网 v2.0 正式上线！欢迎加入我们。",
  },
];
